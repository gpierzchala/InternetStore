...
namespace BusinessLogic.Models
{
    public class RegisterModel
    {
        ...
        [DataAnnotationsExtensions.Integer(ErrorMessage = "Numer budynku powinien być wartością liczbową")]
        public string HouseNumber { get; set; }

        [DisplayName("Numer mieszkania")]
        [DataAnnotationsExtensions.Integer(ErrorMessage = "Numer mieszkania powinien być wartością liczbową")]
