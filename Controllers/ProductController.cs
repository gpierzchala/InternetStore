...
namespace SklepInternetowy.Controllers
{
    public class ProductController : BaseController
    {
        ...
        private readonly Product productLogic;
        ...
        {
            productLogic = new Product(productsRepo);
        ...
        public ActionResult Details(int id)
        {
            ...
            _products = productLogic.GetSimilarProducts(6, product.Category.Name, product.ID);
        ...
        {
            _products = productLogic.GetProductsInCategory(id);

            if (_products == null)
                return View(("_Error"));

            ViewBag.CategoryName = _catRepo.Get(id).Name;
        ...
        {
            _products = productLogic.GetManufacturerProducts(id);

            if (_products == null)
                return View(("_Error"));

            ViewBag.ManufacturerName = _manufacturersRepository.Get(id).Name;
            _onePageOfProducts = Common.SortAndPagin(sortOption, page, null, _products);
        ...
        {
            _products = productLogic.GetAllProducts();
        ...
        {
            _products = _productsRepository.SearchProducts(category, search);
